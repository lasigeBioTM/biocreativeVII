...
import json
with open('C:\\Users\\rcass\\Documents\\C_FCUL\\scripts\\gene_symbol_thesaurus.txt', mode='r', encoding='utf-8') as in_file, \
open('C:\\Users\\rcass\\Documents\\C_FCUL\\scripts\\out.txt', mode='w', encoding='utf-8') as out_file:
    d = {}
    next(in_file)
    for line in in_file:
        line = line.rstrip()
